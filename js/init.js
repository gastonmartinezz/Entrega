...
document.addEventListener("DOMContentLoaded", () => {
  ...
  //Si no esta definido el local, cargar dia
...
//Funcion para cambiar modo 
function toggle() {
  const body = document.body;

  //Si carga la pagina, tomar modo del local
  if (body.classList == ""){
    body.classList.add(localStorage.getItem("modo")); 
  
  //Sino, cambiar el modo establecido
  } else {
    body.classList.toggle('dia');
  ...
  let modoLocal;
  //Si contiene clase dia, cargarlo en el local y cambiar icono. Else, para noche
